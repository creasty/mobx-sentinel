 ...
 *
 * Form.prototype inherits from this object (see below the class), so every form has the methods
 * while Form.prototype itself is left as the class defines it.
 */
const bindingExtensions = {};
